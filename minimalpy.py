...
while running:
	...
	for pointindex in polys:
		pygame.draw.line(screensurf, (255,0,0), pixpoints[pointindex[0]-1],pixpoints[pointindex[1]-1])
		pygame.draw.line(screensurf, (255,0,0), pixpoints[pointindex[1]-1],pixpoints[pointindex[2]-1])
		pygame.draw.line(screensurf, (255,0,0), pixpoints[pointindex[0]-1],pixpoints[pointindex[2]-1])
	#pygame.draw.circle(screensurf,(255,0,0),(50,50),40)
	#pygame.surfarray.blit_array(screen,screenarr)
